...
const protocols = [
  ...
  { id: 'kbtc', label: 'kBTC', category: 'asset', score: 62, description: 'Kraken-issued wrapped BTC. 1:1 backed, SPDI-held. Listed on Tydro, Velodrome, Nado.', url: 'https://kraken.com', krakenTier: 'owned' },
