...
const HERO_IMAGE = '/alpha-briefs-hero.png';
  ...
  return (
    <div className="parchment-card rounded-lg overflow-hidden" data-testid={`brief-${brief.slug}`}>
      ...
      <div className="p-5">
        ...
        <p className="text-sm leading-relaxed" style={{ fontFamily: 'var(--font-serif)', color: 'hsl(28 30% 28%)' }}>
          {brief.description}
        </p>
  ...
  return (
    <>
      ...
      <div className="p-4 sm:p-6 space-y-6 max-w-[900px] mx-auto">
        <PageHeroImage src={HERO_IMAGE} alt="Blog" priority />
